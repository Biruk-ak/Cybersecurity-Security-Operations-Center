...
import type { CloudSecurityRecord } from '../../types/cloud-security';
export const CloudSecurityTable: React.FC<{
  items: CloudSecurityRecord[]; selectedIds: string[]; onSelect: (ids: string[]) => void;
  onRowClick: (id: string) => void; renderSeverity: (n: number) => React.ReactNode;
}> = ({ items, selectedIds, onSelect, onRowClick, renderSeverity }) => (
  <table className="soc-table cloud-security-table">
