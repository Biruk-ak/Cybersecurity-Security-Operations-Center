#ifndef SOC_DETECTION_RULES_RULE_EVAL_04_001_H
#define SOC_DETECTION_RULES_RULE_EVAL_04_001_H
#include <stdint.h>
#include <stddef.h>
#include <stdbool.h>

#define SOC_RULE_EVAL_04_001_MAX 8192
...
} soc_rule_eval_04_001_rec_t;

typedef struct { soc_rule_eval_04_001_rec_t *items; size_t capacity; size_t count; uint64_t seq; } soc_rule_eval_04_001_db_t;

soc_rule_eval_04_001_db_t *soc_rule_eval_04_001_db_create(size_t n);
void soc_rule_eval_04_001_db_destroy(soc_rule_eval_04_001_db_t *db);
...
#endif /* SOC_DETECTION_RULES_RULE_EVAL_04_001_H */
