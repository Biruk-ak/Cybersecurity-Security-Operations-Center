...
export const FirewallManagementChart: React.FC<{ data: Array<{ ts: string; count: number; severityAvg: number }>; section?: string; height?: number }> = ({ data, section, height=220 }) => {
