...
import type { AiThreatDetectionRecord } from '../../types/ai-threat-detection';
export const AiThreatDetectionTable: React.FC<{
  items: AiThreatDetectionRecord[]; selectedIds: string[]; onSelect: (ids: string[]) => void;
  onRowClick: (id: string) => void; renderSeverity: (n: number) => React.ReactNode;
}> = ({ items, selectedIds, onSelect, onRowClick, renderSeverity }) => (
  <table className="soc-table ai-threat-detection-table">
