...
import type { K8sSecurityRecord } from '../../types/k8s-security';
export const K8sSecurityTable: React.FC<{
  items: K8sSecurityRecord[]; selectedIds: string[]; onSelect: (ids: string[]) => void;
  onRowClick: (id: string) => void; renderSeverity: (n: number) => React.ReactNode;
}> = ({ items, selectedIds, onSelect, onRowClick, renderSeverity }) => (
  <table className="soc-table k8s-security-table">
