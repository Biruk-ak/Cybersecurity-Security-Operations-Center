#ifndef SOC_SHARED_JSON_MINI_3_H
#define SOC_SHARED_JSON_MINI_3_H
#include <stdint.h>
#include <stddef.h>
#include <stdbool.h>

#define SOC_JSON_MINI_3_MAX 8192
...
} soc_json_mini_3_rec_t;

typedef struct { soc_json_mini_3_rec_t *items; size_t capacity; size_t count; uint64_t seq; } soc_json_mini_3_db_t;

soc_json_mini_3_db_t *soc_json_mini_3_db_create(size_t n);
void soc_json_mini_3_db_destroy(soc_json_mini_3_db_t *db);
...
#endif /* SOC_SHARED_JSON_MINI_3_H */
